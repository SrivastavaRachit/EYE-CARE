...
const Footer = () => {
    ...
    return (
        <footer className="relative bg-gray-900 text-white mt-8 py-12 px-4 sm:px-6 md:px-16">
            {/* Newsletter Card */}
            <div className="absolute inset-x-0 -top-10 mx-auto w-11/12 sm:w-4/5 md:w-3/5 lg:w-2/5 bg-white
                text-gray-900 p-4 sm:p-6 rounded-t-lg rounded-b-3xl shadow-xl flex flex-col sm:flex-row items-center space-y-4 sm:space-y-0 sm:space-x-4 justify-between z-10 max-w-md md:max-w-lg lg:max-w-xl xl:max-w-2xl">
            ...
            <div className="container mx-auto mt-24 sm:mt-32 grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-8">
                ...
                <div className="flex flex-col items-start">
                    ...
                    <p className="text-sm sm:text-base mt-2 max-w-xs">
                        EYECARE is your trusted partner in health. We provide world-class services for all your medical needs.
                    </p>
                    <div className="flex space-x-4 mt-4">
                        <a href="https://www.facebook.com/profile.php?id=61567156598660&mibextid=JRoKGi" className="bg-white p-2 rounded-full text-blue-600">
                            <FaFacebookF />
                        </a>
                        <a href="https://x.com/HexagonDService?t=Vv5ReZAIbXONqkq_O0ksWQ&s=09" className="bg-black p-2 rounded-full text-blue-600">
                            <FaTwitter />
                        </a>
                        <a href="https://www.instagram.com/hexagondigitalservices?igsh=MWp2NG1oNTlibWVnZA%3D%3D" className="bg-white p-2 rounded-full text-red-600">
                            <FaInstagram />
                        </a>
                        <a href="https://www.linkedin.com/company/hexagondigtial-services" className="bg-blue-600 p-2 rounded-full text-white">
                            <FaLinkedinIn />
                        </a>
                    </div>
                </div>
                ...
                <div>
                    ...
                    <ul className="text-sm font-semibold md:text-base space-y-1">
                        {[{ day: "Monday", time: "9AM to 9PM" }, { day: "Tuesday", time: "9AM to 9PM" }, { day: "Wednesday", time: "9AM to 9PM" }, { day: "Thursday", time: "9AM to 9PM" }, { day: "Friday", time: "9AM to 9PM" }, { day: "Saturday", time: "9AM to 9PM" }, { day: "Sunday", time: "Closed" }]
                            .map((schedule, index) => (
